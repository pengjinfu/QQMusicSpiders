...
class IndexInfo(object):
    ...
    def index(self, day):
        ...
        with open(f'../src/html/index_{day}.html', 'w', encoding='utf-8') as file:
            file.write(html)

    def handle_index(self, day):
        with open(f'../src/html/index_{day}.html', 'r', encoding='utf-8') as file:
            html = file.read()
    ...
    def index_other(self, day):
        ...
        html = response.json()
        print(html)
        with open(f'../src/json/index_{day}.json', 'w', encoding='utf-8') as file:
            file.write(json.dumps(html))

    def hanlde_index_other(self, day):
        with open(f'../src/json/index_{day}.json', 'r', encoding='utf-8') as file:
            html = file.read()
    ...
    def main(self):
        ...
        if os.path.exists(f'../src/html/index_{yestoday}.html'):
            os.remove(f'../src/html/index_{yestoday}.html')
        if os.path.exists(f'../src/json/index_{yestoday}.json'):
            os.remove(f'../src/json/index_{yestoday}.json')
        if os.path.exists(f'../src/html/index_{day}.html'):
            pass
        else:
            self.index(day)
        if os.path.exists(f'../src/html/index_{day}.json'):
            pass
        else:
